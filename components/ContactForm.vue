<template>
  <div
    class="md:col-span-2 row-span-3 bg-opacity-50 bg-white dark:bg-white/5 rounded-md p-4 border border-zinc-800/50"
  >
    <h1 class="font-bold text-sm dark:text-slate-500 mb-1">EMAIL</h1>
    <p v-if="emailError" class="text-red-500 font-medium italic mb-1">
    ...
    <input
      ...
      type="text"
      class="w-full p-2 mb-4 rounded-md bg-slate-300/50 dark:bg-slate-200/5 text-sm placeholder:text-gray-600 dark:placeholder:text-slate-200/20"
    />

    <h1 class="font-bold text-sm dark:text-slate-500 mb-1">MESSAGE</h1>
    <p v-if="msgError" class="text-red-500 font-medium italic mb-1">
      Please provide at least 50 characters.
    </p>
    <textarea
      v-model="message"
      placeholder="Hello Kozou, do you know flies can actually fly?"
    ...
    />
    <p v-if="formError" class="text-red-500 font-medium italic mb-1">
